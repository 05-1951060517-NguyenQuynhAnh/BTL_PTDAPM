...
<head>
    ...
    <title>Tạo tài khoản | GUCCI Official</title>
...
<body style="background:#f6f1eb">
            ...
            <div class="px-5  py-2">
                <div class="d-flex">
                    ...
                    <div style="width: 40%;" class=" d-flex justify-content-end">
                        ...
                        <div class="mt-3">
                            <div class="pt-1 text-decoration-none text-black d-flex" data-bs-toggle="offcanvas"
    ...
    <section style="">
        <div class="container d-flex justify-content-center">
            <div style="background:#ffffff;" class="w-75  m-5 ">
                <div class="p-5 pt-4">
                    <font STYLE="margin-start:20px;letter-spacing: 2.75px;word-spacing:2px" face="Candara" size="6">TẠO
                        TÀI KHOẢN MỚI
                    </font>
                    <form class="form-signin" action="process_signup.php" method="post">
                        <div class="row mt-5">
                            <div class="col-md">
                                ...
                                <div class=" mt-3">
                                    <label style="font-size:12px" for="matkhau">Mật khẩu*</label>
                                    <input type="password" class="col-md-12 ps-3 border py-2 " name="matkhau" required>
                                </div>
                                <div class=" mt-3">
                                    <label style="font-size:12px" for="matkhau">Nhập lại mật khẩu*</label>
                                    <input type="password" class="col-md-12 ps-3 border py-2 " name="re-matkhau"
                                        required>
                                </div>
                                <font STYLE="margin-start:20px;letter-spacing: 1.5px;word-spacing:1px" face="Candara"
                                    size="2">Để bảo mật thông tin cho bạn, chúng tôi mời bạn điền mật khẩu theo các tiêu
                                    chí sau:
                                </font>
                                <div class="ms-3">
                                    <font STYLE="margin-start:20px;letter-spacing: 1.5px;word-spacing:1px"
                                        face="Candara" size="2">➀ Ít nhất 10 ký tự
                                    </font> <br>
                                    <font STYLE="margin-start:20px;letter-spacing: 1.5px;word-spacing:1px"
                                        face="Candara" size="2">➁ Ít nhất 1 chữ in hoa
                                    </font><br>
                                    <font STYLE="margin-start:20px;letter-spacing: 1.5px;word-spacing:1px"
                                        face="Candara" size="2">➂ Ít nhất 1 ký tự đặc biệt
                                    </font><br>
                                </div>
                            </div>
                            <div class="col-md">
                                <font STYLE="margin-start:20px;letter-spacing: 2.75px;word-spacing:2px" face="Candara"
                                    size="4">THÔNG TIN CÁ NHÂN
                                </font>
                                <hr class="m-0 mt-1">
                                <div class="">
                            ...
                            <div class="mx-auto p-1  text-center">
                                <button style="color:white;background:#444"
                                    class="mt-5 pt-1 fw-bold col-md-5 btn btn-lg btn-block" type="submit"
                                    name="btnSignup">
                                    <font STYLE="letter-spacing: 1.75px;word-spacing:1px" face="Candara" size="2">TẠO
                                        TÀI KHOẢN</font>
                                </button>
                            </div>
                    </form>
