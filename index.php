...
<body>
            ...
            <div class="px-5  py-2">
                <div class="d-flex">
                    <div style="width: 40%;"class="d-flex  py-3">
                        ...
                        <div class="ms-3 ">
                            <form id="search-box">
                                ...
                                <input type="text" name="input" class="input pt-2 pb-2 pe-2" id="search-text" placeholder="Tìm kiếm..."
                                    required>
                    ...
                    <div style="width: 40%;"class=" d-flex justify-content-end">
                        ...
                        <div class="mt-3">
                            <a href="login.php" class="mx-auto text-decoration-none link-dark ">
        ...
        <div class="container-fluid">
            <div class="container">
                <div class="p-5">
                    ...
                    <div class="pb-5" style="padding-left:200px;padding-right:200px;">
                        <div class="text-center mt-3">
                            <p class="mt-3" style="font-family:courier,arial,helvetica;">
    ...
    <section style="background:#fff;">
        <div class="container">
            <div style="font-size:15px" class="row p-5">
                ...
                <div class="col-md">
                    ...
                    <div class="mt-3">
                        ...
                        <p class="ms-2 d-inline">nhom12@gmail.com</p>
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <p class="text-center py-3 mb-0" style="background:#f6f1eb;">Copyright © 2023 All rights reserved</p>
    </section>
