        ...
        <div class="container">
            <div style="font-size:15px" class="row p-5 pt-5">
                <div class="col-md-4  me-5">
                    <font class="mt-5" STYLE="letter-spacing: 2.75px;word-spacing:2px" face="Candara" size="6">Giới
                        thiệu</font>
                        <div class="mt-2">
                            <font class="mt-3" STYLE="letter-spacing: 1px;word-spacing:1px" face="Candara" size="3">GUCCI
                                được thành lập vào mùa xuân năm
                                2023, tất cả sản phẩm của GUCCI đều tự thiết kế và sản xuất dựa trên tiêu chí chất lượng. Xin
                                cảm ơn đã ghé thăm!</font>
                        </div>
                </div>
                <div class="col-md-3 me-5 ps-5 d-flex justify-content-center">
                    <div>
                        <font class="mt-5" STYLE="letter-spacing: 2.75px;word-spacing:2px" face="Candara" size="6">Liên
                            kết</font><br>
                        <div class="mt-2">
                            <a class="link-dark text-decoration-none" href="">
                                <font class="mt-5" STYLE="letter-spacing: 1px;word-spacing:1px" face="Candara" size="3">
                                    Trang chủ</font><br>
                            </a>
                        </div>
                        <div class="mt-2">
                        ...
                        <div class="mt-2">
                            <a class="link-dark text-decoration-none" href="">
                                <font class="mt-5" STYLE="letter-spacing: 1px;word-spacing:1px" face="Candara" size="3">
                                    GUCCI SPRING SUMMER 2023</font><br>
                            </a>
                        </div>
                        <div class="mt-2">
                            <a class="link-dark text-decoration-none" href="">
                                <font class="mt-5" STYLE="letter-spacing: 1px;word-spacing:1px" face="Candara" size="3">
                                    GG SUPREME FLORA</font><br>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="col-md d-flex justify-content-end">
                    <div>
                        <font class="mt-5" STYLE="letter-spacing: 2.75px;word-spacing:2px" face="Candara" size="6">Thông
                            tin liên hệ</font>
                        <div class="mt-3">
                            ...
                            <font class="ms-2" STYLE="margin-start:20px;letter-spacing: 1px;word-spacing:1px"
                                face="Candara" size="3">123 Đào Duy Anh, Q.Đống Đa, Hà Nội</font>
                        </div>
                        <div class="mt-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                            ...
                            <font class="ms-2" STYLE="margin-start:20px;letter-spacing: 1px;word-spacing:1px"
                                face="Candara" size="3">0837 473 645</font>
                        ...
                        <div class="mt-3">
                            ...
                            <font class="ms-2" STYLE="margin-start:20px;letter-spacing: 1px;word-spacing:1px"
                                face="Candara" size="3">nhom12@gmail.com</font>
