    ...
    <section>
        <div class="container-fluid">
            ...
            <div class="row d-flex px-5 ms-3 mt-5">
                    ...
                    $sql1 = "SELECT *, product.price-(product.price*product.discount) as Giagiam from detail_catalog,product where detail_catalog.id_dtcatalog=product.catalog_id and product.catalog_id='1'";
