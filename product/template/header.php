...
if (isset($_SESSION['isLoginOK']) && !empty($_SESSION['isLoginOK'])):
    ...
    $sql6 = "SELECT *, COUNT(qty) as tongqty FROM `cart`,user WHERE user.id_user=cart.id_user AND user.email='$id6' ";
...
?>
<div class="header">
    <div class="container-fluid shadow px-5" style="background:#f6f1eb;">
        <div class="px-5  py-2">
            <div class="d-flex">
                ...
                <div style="width: 20%;" class="d-flex justify-content-center">
                    <div class=""> <a href="/BTL_PTDAPM/index.php">
                        <a href="../../../BTL_PTDAPM/index.php" class="">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="d-flex">
                            ...
                            <a class="pt-1 text-decoration-none text-black d-flex"
                                href="/BTL_PTDAPM/cart.php?id=<?php echo $row['id_user']; ?>">
                                <div class="position-relative">
                                    ...
                                    <span style="width: 17px;height: 18px;left:46px;top:2px"
                                        class="text-center p-0 pt-1 m-0 position-absolute  translate-middle badge rounded-circle bg-danger">
                                        <p class="mb-0" style="font-size:10px">
                                            <?php echo $row['tongqty']; ?>
                                        </p>
                                    </span>
                                </div>
                        ...
                        ?>" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
                            <div class="px-5 pt-5  pb-0 offcanvas-header">
                                ...
                                if (isset($_SESSION['isLoginOK']) && !empty($_SESSION['isLoginOK'])):
                                    ?>
                                <font class="offcanvas-title" id="offcanvasExampleLabel"
                                    STYLE="letter-spacing: 2.75px;word-spacing:2px" face="Candara" size="6">TÀI KHOẢN
                                </font>
                                <?php else: ?>
                                <font class="offcanvas-title" id="offcanvasExampleLabel"
                            ...
                            <div class="px-5 offcanvas-body">
                                ...
                                <div class="mt-2">
                                    ...
                                    <a href="/BTL_PTDAPM/order.php" class="text-decoration-none link-dark">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
                                ...
                                <div class="text-center mt-5 pt-5">
                                    <?php
                                        if (isset($_SESSION['isLoginOK']) && !empty($_SESSION['isLoginOK'])):
                                            $id8 = $_SESSION['isLoginOK'];
                                            $sql8 = "SELECT *FROM user WHERE user.email='$id8' ";
