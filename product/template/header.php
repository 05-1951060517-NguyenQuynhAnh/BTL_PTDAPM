                                ...
                                <div class="accordion accordion-flush" id="accordionFlushExample">
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseOne" class="accordion-collapse collapse"
                                            ...
                                            <div class="me-5 ps-4" style="font-size:15px">
                                                <a class="link-dark text-decoration-none" href="shirt.php">
                                                    <p href="../product/shirt.php" class="mt-3 mb-0" style="font-family:courier,arial,helvetica;">
                                                        Áo & Sơ mi
                                                    </p>
                                                </a>
                                                <a class="link-dark text-decoration-none" href="dress.php">
                                                    <p class="mt-2 mb-0" style="font-family:courier,arial,helvetica;">
                                                        Váy đầm
                                                    </p>
                                                </a>
                                                <a class="link-dark text-decoration-none" href="pant.php">
                                                    <p class="mt-2 mb-0" style="font-family:courier,arial,helvetica;">
                                                        Quần
                                                    </p>
                                                </a>
                                                <a class="link-dark text-decoration-none" href="jacket.php">
                                                    <p class="mt-2 mb-0 " style="font-family:courier,arial,helvetica;">
                                                        Áo khoác & Blazer
                                                    </p>
                                                </a>
                                                <a class="link-dark text-decoration-none" href="biki.php">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                            ...
                                            <div class="me-5 ps-4" style="font-size:15px">
                                                <a class="link-dark text-decoration-none" href="sandal.php">
                                                    <p class="mt-3 mb-0" style="font-family:courier,arial,helvetica;">
                                                        Giày & Dép
                                                    </p>
                                                </a>
                                                <a class="link-dark text-decoration-none" href="sneaker.php">
                                                    <p class="mt-2 mb-0" style="font-family:courier,arial,helvetica;">
                                                        Giày thể thao
                                                    </p>
                                                </a>
                                                <a class="link-dark text-decoration-none" href="boots.php">
                                                    <p class="mt-2" style="font-family:courier,arial,helvetica;">
                                                        Bốt
                                                    </p>
                                                </a>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseThree" class="accordion-collapse collapse"
                                            ...
                                            <div class="me-5 ps-4" style="font-size:15px">
                                                <a class="link-dark text-decoration-none" href="bag1.php">
                                                    <p class="mt-3 mb-0" style="font-family:courier,arial,helvetica;">
                                                        Túi đeo vai
                                                    </p>
                                                </a>
                                                <a class="link-dark text-decoration-none" href="bag2.php">
                                                    <p class="mt-2 mb-0" style="font-family:courier,arial,helvetica;">
                                                        Túi quai chéo
                                                    </p>
                                                </a>
                                                <a class="link-dark text-decoration-none" href="bag3.php">
                                                    <p class="mt-2 mb-0" style="font-family:courier,arial,helvetica;">
                                                        Túi tote
                                                    </p>
                                                </a>
                                                <a class="link-dark text-decoration-none" href="bag4.php">
                                                    <p class="mt-2" style="font-family:courier,arial,helvetica;">
                                                        Túi thắt lưng & Balo
                                                    </p>
                                                </a>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="flush-collapseFour" class="accordion-collapse collapse"
                                            ...
                                            <div class="me-5 ps-4" style="font-size:15px">
                                                <a class="link-dark text-decoration-none" href="vi.php">
                                                    <p class="mt-3 mb-0" style="font-family:courier,arial,helvetica;">
                                                        Ví
                                                    </p>
                                                </a>
                                                <a class="link-dark text-decoration-none" href="trangsuc.php">
                                                    <p class="mt-2 mb-0" style="font-family:courier,arial,helvetica;">
                                                        Trang sức
                                                    </p>
                                                </a>
                                                <a class="link-dark text-decoration-none" href="dongho.php">
                                                    <p class="mt-2 mb-0" style="font-family:courier,arial,helvetica;">
                                                        Đồng hồ
                                                    </p>
                                                </a>
                                                <a class="link-dark text-decoration-none" href="kinhmat.php">
                                                    <p class="mt-2 mb-0" style="font-family:courier,arial,helvetica;">
                                                        Kính mắt
                                                    </p>
                                                </a>
                                                <a class="link-dark text-decoration-none" href="khan.php">
                                                    <p class="mt-2 mb-0" style="font-family:courier,arial,helvetica;">
                                                        Khăn & lụa
                                                    </p>
                                                </a>
                                                <a class="link-dark text-decoration-none" href="tl.php">
                                                    <p class="mt-2 mb-0" style="font-family:courier,arial,helvetica;">
                                                        Thắt lưng
                                                    </p>
                                                </a>
                                                <a class="link-dark text-decoration-none" href="mu.php">
                                                    <p class="mt-2 mb-0" style="font-family:courier,arial,helvetica;">
                                                        Mũ & Găng tay
                                                    </p>
                                                </a>
