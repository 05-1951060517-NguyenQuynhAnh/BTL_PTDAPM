        ...
        <nav class="nav">
            <div>
                ...
                <div class="nav_list">
                    ...
                    <a href="../index.php?id=<?php echo $row['id_admin'];?>" class="d-flex nav_link ">
                    ...
                    <a href="taikhoan.php?id=<?php echo $row['id_admin'];?>" class="d-flex nav_link  active">
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor"
                    ...
                    <a href="../sanpham/sanpham.php?id=<?php echo $row['id_admin'];?>" class="d-flex nav_link">
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor"
                ...
                <div class="mt-2 ms-3 row">
                    <div class="login col-md-12 d-flex justify-content-center">
                        <div style="box-shadow: 0 2px 4px 0 #0000001a, 0 8px 16px 0 #0000001a;background:white;width:1200px;border-radius:8px"
                            class="">
                            <p class="text-center text-warning ps-4 mt-3 fs-2 mb-0 fw-bold ">SỬA THÔNG TIN ADMIN</p>
                            <hr>
                            <?php
                                $id1 = $_GET['id1'];
                                ...
                                <div class="pt-1 pb-3 mx-3 row">
                                    ...
                                    <div class="mx-auto p-1  text-center">
                                        <button style="color:white;"
                                            ...
                                            name="btnaddaccount">Lưu lại</button>
                                    </div>
                                </div>
                            </form>
