...
$id = $_GET['id'];
    ...
    $sql = "INSERT INTO product (id_product,catalog_id,name_product,price,import_price,quantity,content,discount,status,image_list) VALUES('$MaSP','$MaLSP','$TenSP','$Giaban','$Gianhap','$Soluong','$Mota','$Giamgia','$Trangthai','$file3')";
