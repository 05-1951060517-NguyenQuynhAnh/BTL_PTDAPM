    ...
    <div class="height-100">
        <section class="p-5">
            <div class="px-5 py-4"
                ...
                <p class="fs-4 fw-bold">Thêm loại hàng</p>
                <?php
            if(isset($_GET['error'])){
                echo "<h5 style ='color:red'>{$_GET['error']}</h5>";
                }
            ?>
                <form action="process_add_loaihang.php?id=<?php echo $id ?>" method="post">

                    <label for="txtMaLH">Mã loại hàng</label>
                    ...
                    <div class="form-group mt-2">
                        <label for="txtTenLH">Tên loại hàng</label>
                        <input type="text" class="col-md-12 ps-3 border py-2 rounded-3" name="txtTenLH"
                            placeholder="Nhập tên sản phẩm" required>
                    </div>
                    <button type="submit" style="background:#f6f1eb" data-bs-toggle="modal"
                        data-bs-target="#staticBackdrop" class="btn  mt-4">Tạo loại hàng mới</button>
                        </form>
                    <?php
                                    if(isset($_GET['error'])){
                                       ?>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                       ...
                                                       <a href="loaihang.php?id=<?php echo $id ?>"><button type="button" class="btn btn-secondary">Quay lại</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div><?php
                ...
                <a class="text-decoration-none link-dark" style="font-size:13px" href="loaihang.php?id=<?php echo $id ?>">
                    <div class="mt-3">
