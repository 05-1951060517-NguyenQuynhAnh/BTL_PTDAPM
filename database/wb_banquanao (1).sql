...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 11, 2023 lúc 05:04 PM
...
INSERT INTO `admin` (`id_admin`, `username`, `password`, `name`, `address`, `phone`, `gender`) VALUES
(1, 'td@gmail.com', '123456', 'Nguyễn Thùy Dương', '', 0, ''),
(2, 'qa@gmail.com', '123456', 'Nguyễn Quỳnh Anh', '', 0, '');
...
(2, 2, NULL, 7, '', '', 0),
(2, 111, NULL, 3, 'Đỏ', '36', 0),
(2, 3, 123456, 3, 'Đen', '38', 12000000),
(2, 212, NULL, 2, 'Đen', '36', 12000000);
...
INSERT INTO `catalog` (`id_catalog`, `name`, `id_admin`) VALUES
(1, 'Quần áo', 0),
(2, 'Giày', 0),
(3, 'Túi xách', 0),
(4, 'Phụ kiện', 0);
...
INSERT INTO `user` (`id_user`, `name`, `email`, `phone`, `address`, `password`, `created`, `date_birth`, `gender`) VALUES
(1, 'Nguyễn Thị Ngọc Bích', 'b@gmail.com', '0965412236', 'Hải Dương', '123456', '2023-04-09', '2001-02-28', ''),
(2, 'Nguyễn Quỳnh Anh ', 'qanh1662001@gmail.com', '9374627473', 'Thanh Hoá', '123456', '0000-00-00', '2023-04-27', 'Nam');
